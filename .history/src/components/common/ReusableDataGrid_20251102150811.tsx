...
const styles = StyleSheet.create({
  ...
  // New container style for the searchbar and add button
  ...
  searchbar: { 
    flex: 1, // Allows searchbar to take up available space
    marginRight: 8, // Adds space before the add button
  },
  addButton: {
    minWidth: 50, // Minimum width for a nice square icon button
    height: 50, // Match the typical height of the searchbar for visual alignment
  ...
  // Actions styles are fine, the icon-only buttons will be smaller now.
