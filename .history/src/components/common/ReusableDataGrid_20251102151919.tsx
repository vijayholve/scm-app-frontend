...
export const ReusableDataGrid: React.FC<ReusableDataGridProps> = ({
  ...
  // FIX: Pass item.id as a parameter object, which is the standard way in React Navigation
    ...
    <Card style={styles.card}>
        <Card.Content>
            {columns.map((col, index) => (
                <View key={col.key} style={[styles.row, index < columns.length - 1 && { borderBottomWidth: 1, borderBottomColor: '#eee' }]}>
