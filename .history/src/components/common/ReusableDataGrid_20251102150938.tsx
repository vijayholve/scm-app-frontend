  ...
  return (
    <View style={styles.container}>
        <View style={styles.headerContainer}>
            ...
            {/* Add button moved next to searchbar */}
        </View>
        <View style={styles.searchAndAddContainer}>
          ...
          />
          {/* Add button placed next to searchbar and made icon-only */}
          {addActionUrl && (
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    ...
    paddingTop: 16,
    paddingBottom: 4, // Reduce space here as search bar follows
  },
  searchAndAddContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 16,
    marginBottom: 12, // More space below the search/add bar
  },
  searchbar: {
    flex: 1,
    marginRight: 8,
  ...
  addButton: {
    ...
    borderRadius: 25, // Rounded icon button
    backgroundColor: '#4CAF50', // A more prominent color for ADD
  },
  listContainer: { 
  ...
  card: {
    marginVertical: 6, // Increased vertical margin between cards
    borderRadius: 8, // Rounded corners for the card
    elevation: 3, // Clearer shadow to lift the card
    backgroundColor: '#ffffff',
  },
  row: { 
    flexDirection: 'row', 
    justifyContent: 'space-between', 
    paddingVertical: 6, // Increased vertical padding for row readability
    alignItems: 'center',
    borderBottomWidth: 1, // Separator line for rows within the card
    borderBottomColor: '#eee',
  },
  headerText: { 
    flex: 1, 
    fontWeight: 'bold', 
    color: '#757575', // Darker but not black header text
    fontSize: 14,
  },
  valueText: { 
    flex: 2, 
  ...
  actions: { 
    ...
    paddingTop: 8,
    borderTopWidth: 1,
    borderTopColor: '#f5f5f5', // Light divider for actions
    gap: 4, // Reduced gap between icon buttons
  },
  emptyContainer: { 
    flex: 1, 
    justifyContent: 'center', 
